...
<head>
    ...
    <title>登录|网上选课管理系统</title>
    <meta name="keywords" content="网上选课管理系统">
</head>
<body>

<div class="header" style="padding: 0;">
    <h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">网上选课管理系统</h2>
</div>
...
<div class="footer">Copyright &nbsp; producer @ 岳观志&张秋鑫&林东铄 </div>
