	...
	<div id="addDialog" style="padding: 10px">  
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
				...
				<tr>
					<td>学号:</td>
					<td><input id="add_nd" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="nd" data-options="required:true, missingMessage:'请填写学号'" /></td>
				</tr>
	    		<tr>
	    			<td>密码:</td>
	    			<td>
    	...
    	<form id="editForm" method="post">
	    	...
	    	<table cellpadding="8" >
				...
				<c:if test="${userType == 1 || userType == 3}">
					<tr>
						<td>学号:</td>
						<td><input id="edit_sn" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="sn" data-options="required:true, missingMessage:'请填写学号'" /></td>
					</tr>
				</c:if>
				<tr>
	    			<td>性别:</td>
